    ...
    return (
        <div className="container mx-auto px-6 py-20 min-h-screen text-[var(--color-brand-text-secondary)]">
            ...
            <div className="max-w-2xl mx-auto">
                <h1 className="text-2xl md:text-3xl font-bold text-white mb-8">Suppression de compte</h1>
                ...
                <h2 className="text-xl font-bold text-white mb-6">Comment procéder ?</h2>
                ...
                <div className="space-y-8">
                    <div className="glass-panel p-8 rounded-2xl relative overflow-hidden group">
                        ...
                        <ol className="list-decimal pl-5 space-y-3 marker:text-[var(--color-brand-accent)] text-sm">
